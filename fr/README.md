...
> **Clarification des idées fausses les plus courantes concernant le bitcoin.**
...
<details>
  ...
  Pour ses partisans, la valeur intrinsèque du bitcoin réside dans le fait qu'il s'agit d'un actif **scarré**, **non corrélé**, doté de propriétés intangibles uniques (**immuable**, **ouvert**, **sans frontières**, **décentralisé**, **résistant à la censure**, etc.)

  Pour la première fois dans l'histoire, toute personne dans le monde disposant d'une connexion internet peut fonctionner comme **sa propre banque** tout en participant à l'économie avec **le plein contrôle de sa richesse**.

  Les sept caractéristiques de la monnaie sont les suivantes : **durabilité**, **portabilité**, **divisibilité**, **uniformité**, **offre limitée** et **acceptabilité**. De nombreux partisans du bitcoin croient fermement que **le bitcoin remplit toutes ces conditions** et qu'il s'agit donc d'une monnaie dure ayant une réelle valeur intrinsèque.

  Souvent, ceux qui n'attribuent aucune valeur intrinsèque au bitcoin le font en raison d'une connaissance imparfaite, d'une perspective étroite et/ou de cadres anciens qui sous-représentent, voire déforment, les capacités du bitcoin et l'idée même de " valeur ".

  Autres lectures (anglais): [Kraken Intelligence - Bitcoin & Intrinsic Value](../_static/Bitcoin-Intrinsic-Value.pdf ':ignore')
