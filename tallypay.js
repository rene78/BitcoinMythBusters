...
var tallypay = function (user, fundid, ex_rates_inc, is_button, button_text, clickable_image, htmlid, theme, success_callback, logged_in_as) {
  ...
  var fundtimer, paytimer, tc_spinner; var paychk = ""; var conw = ""; var conc = "";
  ...
  function call_api(params, endpoint) {
    ...
    if (endpoint == '/v1/fundraiser/index.php' || endpoint == '/v1/user/default_fundraiser/index.php') {
      xhr.onload = function () {
  ...
  function insertHTML() {
    ...
    if (is_button != "Y") {
      ...
      Array.prototype.forEach.call(c, function (el) {
        if (b.height == 0 || clickable_image != '') { var h = 900; } else { var h = b.height + 30; }
